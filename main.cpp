...
int main(int , char* [])
{
    ...
    unsigned char *out_buffer_video=(unsigned char *)av_malloc(av_image_get_buffer_size(AV_PIX_FMT_YUV420P,  pCodecCtx_Video->width, pCodecCtx_Video->height,1));
    ...
    SDL_Window *screen = SDL_CreateWindow("GtPlayer", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
                                          pCodecCtx_Video->width*2, pCodecCtx_Video->height*2,SDL_WINDOW_OPENGL);
    ...
    SDL_Texture *sdlTexture = SDL_CreateTexture(sdlRenderer, SDL_PIXELFORMAT_IYUV, SDL_TEXTUREACCESS_STREAMING,pCodecCtx_Video->width,pCodecCtx_Video->height);
